...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.eunoia.build.version";
    public static final String PROP_DEVICE = "ro.eunoia.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.lineage.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "eunoia.updater.allow_downgrading";
